...
public abstract class Terreno {
	 ...
	 * 
	 * 
	 * Debido a que en el método abstracto el padre no ha definido el comportamiento,
	 * se dice que la clase hija implementará el comportamiento,
	 * es decir, las subclases son responsables de la implementación.
	 * 
	 * @return
	 */
